...
function ProjectEntry({ entry }: {entry: ProjectEntry }) {
    return (
        <Card className='bg-transparent text-white h-full rounded-none flex flex-col justify-between'>
            <CardHeader>
                <CardTitle className="text-3xl font-light">{entry.title}</CardTitle>
            </CardHeader>
            <CardContent >
                <Drawer>
                    ...
                    <DrawerContent className="h-1/2 border-white border-1 rounded-none bg-black">
                        ...
                        <Card className='p-3 inherit rounded-none border-l-0 border-t-0 border-b-0 border-r-1 border-neutral-900 text-white bg-transparent'>
                            <CardHeader className='px-3'>
                                <CardTitle className='text-3xl font-light p-0'>{entry.title}</CardTitle>
                            </CardHeader>
                            <CardDescription className='text-lg font-light text-wrap px-3'>
                                {entry.desc}
                            </CardDescription>
                        </Card>
                        </DrawerDescription>
        ...
        <div className='font-inherit w-screen px-12 flex flex-col'>
            <Carousel orientation='horizontal' className="relative flex w-full max-w-2xl gap-2 border-white border-x-1 box-border">
                <CarouselContent className="-ml-1">
                    {EXAMPLEPROJECT2.map((entry: ProjectEntry, index: number) =>
