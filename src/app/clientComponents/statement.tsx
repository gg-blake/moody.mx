...
export default function Statement(props: {children: any, src?: string}) {
    return (
        <div className="w-full h-auto p-6 text-3xl lg:text-6xl flex flex-col gap-3 sm:flex-row-reverse">
            {props.src && <div className="grow w-full h-full flex justify-right flex-row-reverse"><img className="w-full opacity-70 h-auto rounded-lg" src={`/${props.src}`} alt="profile-cropped.jpg" /></div>}
